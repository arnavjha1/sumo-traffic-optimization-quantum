...
OUTPUT_DIR = BASE_DIR / "quantum_data_3x3"
...
def extract_metrics(output):
    ...
    if (
        ...
        raise ValueError("Could not parse 3x3 traffic metrics or ENERGY_JSON.")
...
vehicles_inserted_averages = []
vehicles_remaining_averages = []
...
for file_path in FILES:
    ...
    vehicles_inserted = [run["vehicles_inserted"] for run in successful_runs]
    vehicles_remaining = [run["vehicles_remaining"] for run in successful_runs]
    ...
    vehicles_inserted_stats = calculate_stats(vehicles_inserted)
    vehicles_remaining_stats = calculate_stats(vehicles_remaining)
    ...
    if successful_runs:
        ...
        vehicles_inserted_averages.append(vehicles_inserted_stats["mean"])
        vehicles_remaining_averages.append(vehicles_remaining_stats["mean"])
    ...
    all_results[simulation_name] = {
        ...
        "statistics": {
            ...
            "vehicles_inserted": vehicles_inserted_stats,
            "vehicles_remaining": vehicles_remaining_stats,
...
overall_summary = {
    ...
    "vehicles_inserted": calculate_stats(vehicles_inserted_averages),
    "vehicles_remaining": calculate_stats(vehicles_remaining_averages),
...
all_results["summary"] = {
    ...
    "vehicles_inserted_averages_by_file": vehicles_inserted_averages,
    "vehicles_remaining_averages_by_file": vehicles_remaining_averages,
...
json_output_file = OUTPUT_DIR / "quantum_3x3_simulation_results.json"
txt_output_file = OUTPUT_DIR / "quantum_3x3_simulation_summary.txt"
...
with open(txt_output_file, "w", encoding="utf-8") as f:
    ...
    f.write("Vehicles inserted averages by file:\n")
    f.write(str(vehicles_inserted_averages) + "\n\n")

    f.write("Vehicles remaining averages by file:\n")
    f.write(str(vehicles_remaining_averages) + "\n\n")
...
print("\nVehicles inserted averages by file:")
print(vehicles_inserted_averages)

print("\nVehicles remaining averages by file:")
print(vehicles_remaining_averages)
