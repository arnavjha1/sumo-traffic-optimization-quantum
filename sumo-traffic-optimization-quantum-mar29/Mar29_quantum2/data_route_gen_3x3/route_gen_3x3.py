...
for ALPHA_INDEX in ALPHA_INDICES:
    ...
    print("\n" + "=" * 60)
    print(f"GENERATING 600s ROUTE FILE FOR a{ALPHA_INDEX}")
    print("=" * 60)

    ROUTE_PROBABILITIES_CSV = (
        BASE_DIR
        / "generated_data"
    ...
    ROUTES_OUTPUT_XML = (
        Path("grid_3x3/routes_3x3")
        / f"routes3x3_a{ALPHA_INDEX}.rou.xml"
    )
